...
export const Badge = ({ children, variant = "gray", size = "md", capitalize = true, icon, as, href }: BadgeProps) => {
  const badgeClasses = clsx(
    "inline-flex justify-center items-center shrink-0 rounded-[9999px] font-sans font-medium whitespace-nowrap tabular-nums transition-all duration-300",
  ...
  if (href) {
    return (
      <a className={clsx("!no-underline hover:scale-105", badgeClasses)} href={href}>
